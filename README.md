...
- [`Test Cases/verify-slideshow-example`](Scripts/verify-slideshow-example/Script1539674312799.groovy) --- I have written as many comments as I could. Please read the source.
...
7. Finally you need to develop test cases and test suites. Create a mimic of [`Test Cases/verify-slideshow-example`](Scripts/verify-slideshow-example/Script1539674312799.groovy) and modify it as you would like.
